 ...
 * @param {number} value
 */
/* const getFreezingTemperatures = (temperature = 0) => {
    let tempArray = temperature.filter(function(temperature){
        return temperature < 0;
    });
    return tempArray;
} */

const getFreezingTemperatures = (temp) => temp.filter(temp => temp < 0) 
